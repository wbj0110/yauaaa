...
public abstract class MatcherAction implements Serializable {
    ...
    public abstract ParserRuleContext parseWalkerExpression(UserAgentTreeWalkerParser parser);
    ...
    public static final Map<Class, CalculateInformPathFunction> CALCULATE_INFORM_PATH = new HashMap<>();



    static {

     class CalculateInformPathFunctionImpl1 implements CalculateInformPathFunction{
         @Override
         public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
             return  MatcherAction.calculateInformPath(action, treeName, ((MatcherBaseContext) tree).matcher());
         }
     }
        // -------------
        ...
        CALCULATE_INFORM_PATH.put(MatcherBaseContext.class, new CalculateInformPathFunctionImpl1());


        class CalculateInformPathFunctionImpl2 implements CalculateInformPathFunction{
            @Override
            public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
                return  MatcherAction.calculateInformPath(action, treeName, ((MatcherPathIsNullContext) tree).matcher());
            }
        }
       ...
       /* CALCULATE_INFORM_PATH.put(MatcherPathIsNullContext.class,       (action, treeName, tree) ->
        ...
        CALCULATE_INFORM_PATH.put(MatcherPathIsNullContext.class, new CalculateInformPathFunctionImpl2());
        // -------------

        class CalculateInformPathFunctionImpl3 implements CalculateInformPathFunction{
            @Override
            public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
                return  MatcherAction.calculateInformPath(action, treeName, ((MatcherExtractContext) tree).expression);
            }
        }
        ...
        CALCULATE_INFORM_PATH.put(MatcherExtractContext.class, new CalculateInformPathFunctionImpl3());

        class CalculateInformPathFunctionImpl4 implements CalculateInformPathFunction{
            @Override
            public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
                return  MatcherAction.calculateInformPath(action, treeName, ((MatcherVariableContext) tree).expression);
            }
        }
      ...
      /*  // -------------
        ...
        CALCULATE_INFORM_PATH.put(MatcherVariableContext.class, new CalculateInformPathFunctionImpl4());
        // -------------
       ...
       /* CALCULATE_INFORM_PATH.put(MatcherPathContext.class,             (action, treeName, tree) ->
        ...
        class CalculateInformPathFunctionImpl5 implements CalculateInformPathFunction{
            @Override
            public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
                return  MatcherAction.calculateInformPath(action, treeName, ((MatcherPathContext) tree).basePath());
            }
        }
        CALCULATE_INFORM_PATH.put(MatcherPathContext.class, new CalculateInformPathFunctionImpl5());
      ...
      /*  CALCULATE_INFORM_PATH.put(MatcherConcatContext.class,           (action, treeName, tree) ->
        ...
        class CalculateInformPathFunctionImpl6 implements CalculateInformPathFunction{
            @Override
            public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
                return  MatcherAction.calculateInformPath(action, treeName, ((MatcherConcatContext) tree).matcher());
            }
        }
        CALCULATE_INFORM_PATH.put(MatcherConcatContext.class, new CalculateInformPathFunctionImpl6());
      ...
      /*  CALCULATE_INFORM_PATH.put(MatcherConcatPrefixContext.class,     (action, treeName, tree) ->
        ...
        class CalculateInformPathFunctionImpl7 implements CalculateInformPathFunction{
            @Override
            public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
                return  MatcherAction.calculateInformPath(action, treeName, ((MatcherConcatPrefixContext) tree).matcher());
            }
        }
        CALCULATE_INFORM_PATH.put(MatcherConcatPrefixContext.class, new CalculateInformPathFunctionImpl7());
       ...
       /* CALCULATE_INFORM_PATH.put(MatcherConcatPostfixContext.class,    (action, treeName, tree) ->
        ...
        class CalculateInformPathFunctionImpl8 implements CalculateInformPathFunction{
            @Override
            public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
                return  MatcherAction.calculateInformPath(action, treeName, ((MatcherConcatPostfixContext) tree).matcher());
            }
        }
        CALCULATE_INFORM_PATH.put(MatcherConcatPostfixContext.class, new CalculateInformPathFunctionImpl8());
      ...
      /*  CALCULATE_INFORM_PATH.put(MatcherNormalizeBrandContext.class,   (action, treeName, tree) ->
        ...
        class CalculateInformPathFunctionImpl9 implements CalculateInformPathFunction{
            @Override
            public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
                return  MatcherAction.calculateInformPath(action, treeName, ((MatcherNormalizeBrandContext) tree).matcher());
            }
        }
        CALCULATE_INFORM_PATH.put(MatcherNormalizeBrandContext.class, new CalculateInformPathFunctionImpl9());
        ...
        class CalculateInformPathFunctionImpl10 implements CalculateInformPathFunction{
            @Override
            public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
                return  MatcherAction.calculateInformPath(action, treeName, ((MatcherCleanVersionContext) tree).matcher());
            }
        }
        CALCULATE_INFORM_PATH.put(MatcherCleanVersionContext.class, new CalculateInformPathFunctionImpl10());
        ...
        class CalculateInformPathFunctionImpl11 implements CalculateInformPathFunction{
            @Override
            public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
                return  MatcherAction.calculateInformPath(action, treeName, ((MatcherPathLookupContext) tree).matcher());
            }
        }
        CALCULATE_INFORM_PATH.put(MatcherPathLookupContext.class, new CalculateInformPathFunctionImpl11());
       ...
       /* CALCULATE_INFORM_PATH.put(MatcherPathLookupPrefixContext.class,       (action, treeName, tree) ->
        ...
        class CalculateInformPathFunctionImpl12 implements CalculateInformPathFunction{
            @Override
            public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
                return  MatcherAction.calculateInformPath(action, treeName, ((MatcherPathLookupPrefixContext) tree).matcher());
            }
        }
        CALCULATE_INFORM_PATH.put(MatcherPathLookupPrefixContext.class, new CalculateInformPathFunctionImpl12());
       ...
       /* CALCULATE_INFORM_PATH.put(MatcherPathIsInLookupPrefixContext.class,       (action, treeName, tree) ->
        ...
        class CalculateInformPathFunctionImpl13 implements CalculateInformPathFunction{
            @Override
            public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
                return  MatcherAction.calculateInformPath(action, treeName, ((MatcherPathLookupPrefixContext) tree).matcher());
            }
        }
        CALCULATE_INFORM_PATH.put(MatcherPathIsInLookupPrefixContext.class, new CalculateInformPathFunctionImpl13());
...
*/
        class CalculateInformPathFunctionImpl14 implements CalculateInformPathFunction{
            @Override
            public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
                return  MatcherAction.calculateInformPath(action, treeName, ((MatcherWordRangeContext) tree).matcher());
            }
        }
        CALCULATE_INFORM_PATH.put(MatcherWordRangeContext.class, new CalculateInformPathFunctionImpl14());
        ...
        class CalculateInformPathFunctionImpl15 implements CalculateInformPathFunction{
            @Override
            public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
                action.matcher.informMeAboutVariable(action, ((PathVariableContext) tree).variable.getText());
                return 0;
        ...
        CALCULATE_INFORM_PATH.put(PathVariableContext.class, new CalculateInformPathFunctionImpl15());
      ...
      /*  CALCULATE_INFORM_PATH.put(PathWalkContext.class,                (action, treeName, tree) ->
        ...
        class CalculateInformPathFunctionImpl16 implements CalculateInformPathFunction{
            @Override
            public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
                return  MatcherAction.calculateInformPath(action, treeName, ((PathWalkContext) tree).nextStep);
            }
        }
        CALCULATE_INFORM_PATH.put(PathWalkContext.class, new CalculateInformPathFunctionImpl16());
      ...
      /*  CALCULATE_INFORM_PATH.put(StepDownContext.class,                (action, treeName, tree) -> {
        ...
        class CalculateInformPathFunctionImpl17 implements CalculateInformPathFunction{
            @Override
            public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
                StepDownContext thisTree = ((StepDownContext)tree);
                int informs = 0;
        ...
        CALCULATE_INFORM_PATH.put(StepDownContext.class, new CalculateInformPathFunctionImpl17());
       ...
       /* CALCULATE_INFORM_PATH.put(StepEqualsValueContext.class,         (action, treeName, tree) -> {
        ...
        class CalculateInformPathFunctionImpl18 implements CalculateInformPathFunction{
            @Override
            public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
                StepEqualsValueContext thisTree = ((StepEqualsValueContext)tree);
                action.matcher.informMeAbout(action, treeName + "=\"" + thisTree.value.getText() + "\"");
        ...
        CALCULATE_INFORM_PATH.put(StepEqualsValueContext.class, new CalculateInformPathFunctionImpl18());
      ...
      /*  CALCULATE_INFORM_PATH.put(StepStartsWithValueContext.class,     (action, treeName, tree) -> {
        ...
        class CalculateInformPathFunctionImpl19 implements CalculateInformPathFunction{
            @Override
            public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
                StepStartsWithValueContext thisTree = ((StepStartsWithValueContext)tree);
                action.matcher.informMeAboutPrefix(action, treeName, thisTree.value.getText());
        ...
        CALCULATE_INFORM_PATH.put(StepStartsWithValueContext.class, new CalculateInformPathFunctionImpl19());
     ...
     /*   CALCULATE_INFORM_PATH.put(StepWordRangeContext.class,           (action, treeName, tree) -> {
        ...
        class CalculateInformPathFunctionImpl20 implements CalculateInformPathFunction{
            @Override
            public int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
                StepWordRangeContext thisTree = ((StepWordRangeContext)tree);
                Range range = WordRangeVisitor.getRange(thisTree.wordRange());
        ...
        CALCULATE_INFORM_PATH.put(StepWordRangeContext.class, new CalculateInformPathFunctionImpl20());


    }

    public static int calculateInformPath(MatcherAction action, String treeName, ParserRuleContext tree) {
        if (tree == null) {
